...
const footerLinks = {
  ...
  Modules: [
    ...
    { label: "TNC Training", href: "#" },
    { label: "Awards & Points", href: "#" },
  ],
  Company: [
    { label: "About Us", href: "#" },
    { label: "Careers", href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-slate-600">
              The all-in-one workforce management platform for attendance, tasks,
              training, awards, and employee history.
            </p>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} TNC Track. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
